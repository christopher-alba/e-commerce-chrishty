const colors = (props) => {
  ...
  if (props.color === "jcBlue80")
    return `color: ${props.theme.colors.jcBlue80};`;
  if (props.color === "jcBlue60")
    return `color: ${props.theme.colors.jcBlue60};`;
  if (props.color === "jcBlue40")
  ...
  if (props.color === "jcBlueGreen80")
    return `color: ${props.theme.colors.jcBlueGreen80};`;
  if (props.color === "jcBlueGreen60")
    return `color: ${props.theme.colors.jcBlueGreen60};`;
  if (props.color === "jcBlueGreen40")
  ...
  if (props.color === "jcPink80")
    return `color: ${props.theme.colors.jcPink80};`;
  if (props.color === "jcPink60")
    return `color: ${props.theme.colors.jcPink60};`;
  if (props.color === "jcPink40")
  ...
  if (props.color === "jcBlack80")
    return `color: ${props.theme.colors.jcBlack80};`;
  if (props.color === "jcBlack60")
    return `color: ${props.theme.colors.jcBlack60};`;
  if (props.color === "jcBlack40")
  ...
  if (props.color === "jcGrey80")
    return `color: ${props.theme.colors.jcGrey80};`;
  if (props.color === "jcGrey60")
    return `color: ${props.theme.colors.jcGrey60};`;
  if (props.color === "jcGrey40")
