const backgrounds = (props) => {
  ...
  if (props.background === "jcBlue0")
    return `background: ${props.theme.colors.jcBlue0};`;
  ...
  if (props.background === "jcBlueGreen0")
    return `background: ${props.theme.colors.jcBlueGreen0};`;
  ...
  if (props.background === "jcPink0")
    return `background: ${props.theme.colors.jcPink0};`;
  ...
  if (props.background === "jcBlack0")
    return `background: ${props.theme.colors.jcBlack0};`;
  ...
  if (props.background === "jcGrey0")
    return `background: ${props.theme.colors.jcGrey0};`;
